...
################################################# END SECTION OF ANALYSIS FOR BULK DATA #################################################
    ...
    file = 'save/rep_data'+data_name+'_f1_score_ori.txt'
    file1 = 'save/rep_data'+data_name+'_ap_score_ori.txt'
    file2 = 'save/rep_data'+data_name+'_roc_score_ori.txt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=200,help='Number of epoches training. Default: 500')
